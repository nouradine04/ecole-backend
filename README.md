...
```
cd existing_repo
git remote add origin https://gitlab.com/nourad23seid/backendecole.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/nourad23seid/backendecole/-/settings/integrations)
